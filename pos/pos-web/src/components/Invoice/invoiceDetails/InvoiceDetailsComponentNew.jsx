...
const InvoiceDetailsComponentNew = ({ invoiceData, authUserId, authRole }) => {
  ...
  useEffect(() => {
    ...
    setFinalTotal(invoiceData.currentTotal + (invoiceData.previousDue || 0)) -
  ...
  if (authRole === "manager") {
    columns.push({
      ...
      render: (_, record) => {
        ...
        return !invoiceData.status === INVOICE_STATUS.VALUES.Unpaid &&
          record.pBillId &&
          record.pBillNameId ? (
          editable ? (
            <span>
        ...
        <Row style={{ width: "100%" }} justify="space-between">
          ...
          <Col>
            <Row gutter={16} justify="space-between">
              ...
              <Col>
                <Space direction="vertical">
                  <Text> {convertToBD(invoiceData.previousDue || 0)}</Text>
                  ...
                  <Text>
                    {" "}
                    <Tag color={INVOICE_STATUS.KEYS[invoiceData.status].color}>
                      {" "}
                      {INVOICE_STATUS.KEYS[invoiceData.status].text}
                    </Tag>
                  </Text>
                </Space>
              </Col>
...
export default InvoiceDetailsComponentNew;
